...
f.tmp <- read_lines("e:/temp/vasv/server.log")
...
# Handling outliers
slowest_25 <- head(dt[order(-timetaken)], n = 25)
...
ist <- round((nputs_mean / seconds_factor), 1)
...
(Realistische) Änderungen von Vornamen, Nachnamen,  Geburtsdaten und Adressen  über MQSeries.

Mit parallel stattfindendem CDH Standard-Backup (Sicherung der record_actual)
